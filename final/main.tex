...
\include{Appendix/revision}

\addcontentsline{toc}{chapter}{Nhận xét hướng dẫn}
\include{Appendix/advisor}

% Nhận xét của GV phản biện: bản nhận xét (kèm PDF) do giáo vụ cung cấp sau buổi
% bảo vệ. Bỏ chú thích hai dòng dưới khi đã có file PDF tương ứng.
