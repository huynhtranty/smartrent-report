...
SAD & System Analysis and Design & Phân tích và thiết kế hệ thống -- Quy trình nghiên cứu hệ thống để xác định mục tiêu, đặc tả yêu cầu và xây dựng kiến trúc phần mềm. \\
\hline

SDLC & Software Development Life Cycle & Quy trình phát triển phần mềm -- Các giai đoạn từ lập kế hoạch, phân tích yêu cầu, thiết kế, triển khai đến kiểm thử và bảo trì phần mềm. \\
\hline

SRS & Software Requirements Specification & Đặc tả yêu cầu phần mềm -- Tài liệu mô tả chi tiết các yêu cầu chức năng, phi chức năng và hành vi của hệ thống phần mềm. \\
\hline
